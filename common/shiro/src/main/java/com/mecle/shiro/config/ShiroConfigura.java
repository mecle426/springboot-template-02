package com.mecle.shiro.config;

import com.mecle.shiro.filter.JwtFilter;
...
public class ShiroConfigura {
    ...
    @Bean
    public SessionManager sessionManager(RedisSessionDAO redisSessionDAO) {//这里报错不用管，idea的原因
    ...
    public DefaultWebSecurityManager securityManager(AccountRealm accountRealm,
                                                     ...
                                                     RedisCacheManager redisCacheManager) {//这里报错不用管，idea的原因
